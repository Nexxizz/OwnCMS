...
if(isset($_POST['password'])){
    ...
    set_message("You have successfully updated User: " . $_POST['username']);
...
<form method="post">
    ...
    <input type="text" id="username" name="username" class="form-control active" value="$user[username]"/>
    <label class="form-label" for="username">Username</label>
  </div>
  <!-- Email input -->
  <div data-mdb-input-init class="form-outline mb-4">
    <input type="text" id="email" name="email" class="form-control active" value="$user[email]" />
