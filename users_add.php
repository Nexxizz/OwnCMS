...
if(isset($_POST['username']) && isset($_POST['email']) && isset($_POST['password'])) {
    if ($stm = $connect->prepare('INSERT INTO users (username, email, password, active) VALUES (?, ?, ?, ?)')) {
        ...
        set_message("You have successfully added User: " . $_POST['username']);
...
<form method="post">
  ...
  <!-- Email input -->
  <div data-mdb-input-init class="form-outline mb-4">
    <input type="text" id="email" name="email" class="form-control active" />
  ...
  <!-- Submit button -->
  <button data-mdb-ripple-init type="submit" class="btn btn-primary btn-block">Add</button>
</form>
</div>
</div>
</div>
